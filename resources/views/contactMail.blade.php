                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pad"
                                                                    style="padding-bottom:10px;padding-top:10px;width:100%;padding-right:0px;padding-left:0px; text-align:center; color: #FFF;">
                                                                    Mensaje desde su web
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:42px;">{{ $data['subject'] }}</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:16px;">{{ $data['message'] }}</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong><span
                                                                                        style="font-size:18px;">Datos de contacto
                                                                                        </span></strong></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; border-bottom: 0px solid #5D77A9; border-left: 0px solid #5D77A9; border-right: 0px solid #5D77A9; border-top: 0px solid #5D77A9; vertical-align: top;"
                                                    width="50%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pad"
                                                                    style="padding-bottom:15px;padding-left:10px;padding-right:20px;padding-top:15px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong><span
                                                                                        style="font-size:16px;"><span
                                                                                            style="color:#5d77a9;">Nombre</span></span></strong>
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 16px; text-align: right;">
                                                                                <strong><span
                                                                                        style="font-size:16px;"><span
                                                                                            style="color:#5d77a9;">Teléfono</span></span></strong>
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 16px; text-align: right;">
                                                                                <strong><span
                                                                                        style="font-size:16px;"><span
                                                                                            style="color:#5d77a9;">Email</span></span></strong>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span
                                                                                    style="font-size:16px;">{{ $data['name'] }}</span>
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;">
                                                                                <span
